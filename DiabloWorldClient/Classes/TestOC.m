...
//    [_webView setDelegate:self];
    ...
    UINavigationItem *item = [[UINavigationItem alloc]initWithTitle:@"≥‰÷µ"];
    UIBarButtonItem * leftbutton = [[UIBarButtonItem alloc]initWithTitle:@"∑µªÿ" style:UIBarButtonSystemItemUndo target:self action:@selector(click)];
