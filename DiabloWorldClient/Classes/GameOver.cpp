...
bool GameOver::init(){
    ...
    CCLabelTTF* weittf = CCLabelTTF::create(tmp, "hycc.ttf", 18,CCSizeMake(200, 0),kCCTextAlignmentCenter);
    ...
    CCLabelTTF* goldttf = CCLabelTTF::create(tmp1, "hycc.ttf", 18,CCSizeMake(200, 0),kCCTextAlignmentCenter);
    ...
    CCLabelTTF* huolittf = CCLabelTTF::create(tmp2, "hycc.ttf", 18,CCSizeMake(200, 0),kCCTextAlignmentCenter);
...
void GameOver::win(){
    ...
    //    CCLabelTTF *goback=CCLabelTTF::create("·µ  »Ø", "Marker Felt", 30);
...
void GameOver::goBackToHome( CCObject* ted )
{
    CData::getCData()->setyinxiao();
...
void GameOver::receiveGoHomeBack( float det )
{
