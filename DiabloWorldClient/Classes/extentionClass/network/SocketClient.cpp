...
SocketClient::SocketClient(String host, int port, byte clientid,byte serverid,MessageHandler* netImpl):m_iState(SocketClient_WAIT_CONNECT),m_cbRecvBuf(1024*60),m_cbSendBuf(1024*60),m_pHandler(netImpl)
{   
	m_isvalidSeq = false;
