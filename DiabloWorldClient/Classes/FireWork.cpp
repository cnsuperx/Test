...
void Fire::updatalabel( float det )
{
    if(e==10){
...
void Fire::checkOut(){
    ...
    if(chaBattleId!=0){
        ...
        if(eneArr.size()==1)
        {
            ...
            int eneChaid[arrsize];
            int eneChanHp[arrsize];
            int eneCurrHp[arrsize];
            int eneTotHp[arrsize];
            int eneBattId[arrsize];
            int eneActId[arrsize];
...
void Fire::attackData(char * jsonData){
    ...
    if (read.parse(jsonData, value)) {
        ...
        if(eneArr.size()==1)
        {
			...
			const int nowsize = 255;
            int eneChaid[nowsize];
            int eneChanHp[nowsize];
            int eneCurrHp[nowsize];
            int eneTotHp[nowsize];
            int eneBattId[nowsize];
            int eneActId[nowsize];
