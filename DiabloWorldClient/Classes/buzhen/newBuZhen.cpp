                ...
                else
                {
                    if (dragingindex > 9) {
                        ...
                        if (dragingsp->itemdata->tpid == 2 || acceptsp->itemdata->tpid == 2) {
							...
							CustomPop::show("Friends can't swallow");
                        }
                        else{
                            send_3505();
                        }
                    ...
                    else
                    {
						...
						CustomPop::show("Hero of the play cannot be swallowed");
                    }
                }
...
void newBuZhen::rec_3505( float det )
{
...
void newBuZhen::rec_2307( float det )
{
...
void newBuZhen::rec_2300( float det )
{
...
void newBuZhen::rec_2306( float det )
{
