...
bool startAnimate::init()
{
    ...
    CCMenuItemImage *item=CCMenuItemImage::create("start_xr.png", "start_xr1.png", this, SEL_MenuHandler(&startAnimate::callbackSelectRolePtr));
...
void startAnimate::callbackSelectRole()
{
...
void startAnimate::callbackSelectRolePtr( CCObject* ted )
{
	callbackSelectRole();
}
