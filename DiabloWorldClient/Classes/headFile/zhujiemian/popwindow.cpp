...
void buildingpop::buzhen(CCObject* pSender)
{
...
void buildingpop::close(CCObject* pSender){
    this->hide();
}
//
void buildingpop::fight(CCObject* pSender){
	if(lock)
	{
		return;
	}
...
void buildingpop::receiveFireData(float dt){
